...
function hv_segment_meta_box_callback( $post ) {
	...
	echo '
                ...
                Header Text
                <input type="text" name="header_hv" value="' . esc_attr( $header ) . '"  size="60" placeholder=""> <br />';
	echo '</p>';
	echo '<p>';
	echo '
	Description
                <input type="text" name="description_hv" value="' . esc_attr( $description ) . '"  size="60" placeholder=""><br />';
	echo '</p>';
	echo '<p>';
	echo '
                Button Text
                <input type="text" name="button_text_hv" value="' . esc_attr( $button_text ) . '"  size="60" placeholder=""><br />';
	echo '</p>';
	echo '<p>';
	echo '
                Button Link
                <input type="text" name="button_link_hv" value="' . esc_attr( $button_link ) . '"  size="60" placeholder=""><br />';
	echo '</p>';
	echo '<p>';
	echo '
                Disclaimer
                <input type="text" name="disclaimer_hv" value="' . esc_attr( $disclaimer ) . '"  size="60" placeholder=""><br />';
	echo '</p>';
